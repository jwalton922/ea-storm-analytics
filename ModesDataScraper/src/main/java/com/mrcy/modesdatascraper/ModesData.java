...
public class ModesData {
    ...
    public ModesData(String hexCode, String aircraftType, String registrationNumber, String flightNumber, Double latitude, Double longitude, Double altitude, Double heading, Double spead, Integer timeStamp, String airline, String stops) {
