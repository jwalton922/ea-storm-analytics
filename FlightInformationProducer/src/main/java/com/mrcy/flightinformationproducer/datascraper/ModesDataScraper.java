...
public class ModesDataScraper {
    ...
    public List<ModesData> getModesData(double minLat, double minLon, double maxLat, double maxLon) throws IOException, JSONException {
        List<ModesData> aircraftList = new ArrayList<ModesData>();

        HttpClient client = new DefaultHttpClient();
        String getURL = "http://planefinder.net/endpoints/update.php?faa=1&bounds="+minLat+"%2C"+minLon+"%2C"+maxLat+"%2C"+maxLon;
